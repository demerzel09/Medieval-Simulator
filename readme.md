...
**A2買物係・売り手:** `npm run autonomy:a2`で20人経済の3日間の買物係と売り手の判断、補充依頼、売買を表示します。ブラウザの`/?e1=a2`、またはVS Code「自律 A2: 買物係・売り手の空間デバッグ画面」では、人物B0〜B3またはSをクリックして次の判断、本人が知る注文、因果Event、移動、食料・現金を時刻ごとに確認できます。A1と買物係・売り手は[共通の人格入出力型](packages/ai/personality.ts)を使います。旧物体木版`/?e1=v2`は比較用に残しています。農民・運搬人などの本人主導化と90日安定は今後の作業です。
