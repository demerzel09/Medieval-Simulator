...
A3へ向けた所得試作は `npm run autonomy:a3:income -- buyer-no-money`、または `http://127.0.0.1:5173/?e1=a3-income` で確認できます。画面で「H0の資金不足」を選び、2〜3日目のF0やB0をクリックすると、空腹・体力・賃金請求と支払いのEventを追えます。これは**3日の試作**で、90日経済や自律性の受入は未達です。[監査と判定条件](docs/SOCIAL_SIM_AUTONOMY_AUDIT.md)を参照してください。
