...
状態: 2026-09-26の段階実装設計。E1と旧M2軍事コードを照合し、物理的正本は[物体・包含モデル](PHYSICAL_OBJECT_MODEL.md)へ改訂した。L0の独立物体操作・二台馬車試験とL1の独立E1新版は実装済み。旧90日ゲーム/軍補給への接続と共通物流全体の受入試験は**未実装**。E1の3日間の成功を軍兵站の成功とみなさない。
...
複数の荷車・馬・御者・荷役人を組み合わせる計画は[能力エージェントと仕事・道具の市場](CAPABILITY_AGENTS_DESIGN.md)に分ける。物体の容量を集計するだけでは配車、牽引、作業時間、費用と人員の引受は決まらない。
