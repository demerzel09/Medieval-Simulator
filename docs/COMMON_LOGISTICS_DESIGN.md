...
状態: 2026-09-26の段階実装設計。E1の実装と旧M2軍事コードを照合し、物理的正本は[物体・包含モデル](PHYSICAL_OBJECT_MODEL.md)へ改訂した。L0の独立物体操作・二台馬車試験は実装済み。E1/軍補給への接続と共通物流全体の受入試験は**未実装**。E1の3日間の成功を軍兵站の成功とみなさない。
